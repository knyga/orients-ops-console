...
export function buildInvestorPrompt(data: InvestorWeekData): string {
  return [
    ...
    "Внутрішні чи вузькотехнічні терміни (golden dataset, назви підсистем, кодові назви гіпотез тощо) при першій згадці поясни в дужках у 3–5 словах — напр. «golden-датасет (еталонний набір для перевірки)».",
